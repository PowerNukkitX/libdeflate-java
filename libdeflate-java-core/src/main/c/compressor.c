...
LIBDEFLATEJAVA_PUBLIC JNIEXPORT jlong JNICALL Java_org_powernukkitx_libdeflate_LibdeflateCompressor_allocate(JNIEnv *env, jclass klass, jint level) {
...
LIBDEFLATEJAVA_PUBLIC JNIEXPORT void JNICALL Java_org_powernukkitx_libdeflate_LibdeflateCompressor_free(JNIEnv *env, jclass klass, jlong ctx) {
...
LIBDEFLATEJAVA_PUBLIC JNIEXPORT jlong JNICALL Java_org_powernukkitx_libdeflate_LibdeflateCompressor_compressBothHeap
...
LIBDEFLATEJAVA_PUBLIC JNIEXPORT jlong JNICALL Java_org_powernukkitx_libdeflate_LibdeflateCompressor_compressOnlySourceDirect
...
LIBDEFLATEJAVA_PUBLIC JNIEXPORT jlong JNICALL Java_org_powernukkitx_libdeflate_LibdeflateCompressor_compressOnlyDestinationDirect
...
LIBDEFLATEJAVA_PUBLIC JNIEXPORT jlong JNICALL Java_org_powernukkitx_libdeflate_LibdeflateCompressor_getCompressBound(JNIEnv *env, jclass klass, jlong ctx, jlong length, jint type) {
    struct libdeflate_compressor *compressor = (struct libdeflate_compressor *) ctx;
    size_t result = 0;
    switch (type) {
        case COMPRESSION_TYPE_DEFLATE:
